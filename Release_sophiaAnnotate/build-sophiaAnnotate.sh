...
$CPP -L$CONDA_ENV_ROOT/lib -flto -o "sophiaAnnotate"  AnnotationProcessor.o Breakpoint.o BreakpointReduced.o ChrConverter.o DeFuzzier.o GermlineMatch.o MrefEntry.o MrefEntryAnno.o MrefMatch.o SuppAlignment.o SuppAlignmentAnno.o SvEvent.o  HelperFunctions.o sophiaAnnotate.o   -lz -lboost_system -lboost_iostreams
