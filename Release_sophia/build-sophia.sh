...
$CPP -L$CONDA_PREFIX/lib -flto -o "sophia"  Alignment.o Breakpoint.o ChosenBp.o ChrConverter.o SamSegmentMapper.o Sdust.o SuppAlignment.o sophia.o -lboost_program_options