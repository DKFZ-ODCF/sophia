...
namespace sophia {
    ...
    class Alignment {
        ...
        public:
            ...
            const vector<int>& getReadBreakpoints() const {
                return readBreakpoints;
            }
            bool isValidLine() const {
                return validLine;
            }
            const string& getSamLine() const {
                return samLine;
            }
        ...
        private:
            ...
            void fullMedianQuality(Iterator qualBegin, Iterator qualEnd, vector<int>& overhangPerBaseQuality) const;
            template<typename Iterator>
    ...
    template<typename Iterator>
    void Alignment::fullMedianQuality(Iterator qualBegin, Iterator qualEnd, vector<int>& overhangPerBaseQuality) const {
