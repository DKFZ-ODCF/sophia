...
namespace sophia {
    ...
    class SuppAlignment {
      ...
      public:
        ...
        static SuppAlignment parseSaSupport(const std::string &saIn);
        ...
        static SuppAlignment parseSamSaTag(
                            std::string::const_iterator saCbegin,
        ...
        /** Print the supplementary alignment information as displayed in columns 6 and 7 of the
          ...
          * `SuppAlignmentAnno::SuppAlignmentAnno(const std::string&)`. */
        ...
        void addSecondarySupportIndices(
            const std::vector<int> &supportingIndicesSecondaryIn) {
