...
namespace sophia {
    ...
    class Breakpoint {
        public:
            ...
            bool finalizeBreakpoint(const deque<MateInfo>& discordantAlignmentsPool, const deque<MateInfo>& discordantLowQualAlignmentsPool, const deque<MateInfo>& discordantAlignmentCandidatesPool);
        ...
        private:
            ...
            bool matchDetector(const shared_ptr<Alignment>& longAlignment, const shared_ptr<Alignment>& shortAlignment) const;
            void detectDoubleSupportSupps();
            void collapseSuppRange(string &res, const vector<SuppAlignment>& vec) const;
            template<typename T>
            void cleanUpVector(vector<T>& objectPool);
            void fillMatePool(const deque<MateInfo>& discordantAlignmentsPool, const deque<MateInfo>& discordantLowQualAlignmentsPool, const deque<MateInfo>& discordantAlignmentCandidatesPool);
            void collectMateSupport();
            void compressMatePool(vector<MateInfo>& discordantAlignmentsPool);
            void collectMateSupportHelper(SuppAlignment& sa, vector<MateInfo>& discordantAlignmentsPool, vector<MateInfo>& discordantLowQualAlignmentsPool);
        ...
        template<typename T>
        inline void Breakpoint::cleanUpVector(vector<T>& objectPool) {
